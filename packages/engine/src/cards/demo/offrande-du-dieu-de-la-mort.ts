...
export const offrandeDuDieuDeLaMort: ObjectCardDef = {
  ...
  description:
    'Une sélection de 6 cartes objets aléatoire dans le jeu se présente à vous, choisissez en une. Une sélection de 2 cartes objets aléatoire dans le jeu se présente à votre adversaire, il en choisit une.',
  async execute(ctx) {
