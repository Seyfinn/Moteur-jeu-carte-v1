  ...
  return (
    <div className="lobby-layout">
      <div className="lobby">
        ...
        <div className="lobby-deck-menu">
          <button className="deck-manager-link" onClick={onManageDecks}>
            Gérer mes decks
          </button>
          <button className="deck-manager-link" onClick={onCreateDeck}>
            Créer un deck
          </button>
          <button className="deck-manager-link" onClick={onImportDeck}>
            Importer un deck
          </button>
        </div>
      ...
      {selectedDeck && <DeckContentsPanel title="Contenu du deck" deck={selectedDeck} pool={poolByType} />}
    </div>
  );
}
